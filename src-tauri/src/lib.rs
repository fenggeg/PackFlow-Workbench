...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::build::preflight_build,
            ...
            commands::dependency::cancel_dependency_scan,
            ...
            commands::jar::inspect_jar,
            commands::jar::read_jar_entry,
            commands::jar::update_jar_entries,
            commands::jar::list_jar_backups,
            commands::jar::delete_jar_backups,
            commands::jar::restore_jar_backup,
            ...
            commands::data::backup_app_data,
            commands::data::restore_app_data,
            commands::data::export_diagnostics,
